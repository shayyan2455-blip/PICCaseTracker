      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        {step === 'account' ? (
          <>
            ...
            <p className="mb-6 text-sm" style={{ color: 'color-mix(in srgb, var(--text-color) 60%, transparent)' }}>Start tracking your PIC cases</p>
            ...
            <form onSubmit={handleCreateAccount} className="flex flex-col gap-4">
              <div>
                ...
                <input id="signup-email" type="email" required value={email} onChange={(e) => setEmail(e.target.value)}
                  ...
                  style={{ backgroundColor: 'var(--second-bg-color)', borderColor: 'color-mix(in srgb, var(--text-color) 15%, transparent)', color: 'var(--text-color)' }}
          ...
          <>
            ...
            <p className="mb-6 text-sm" style={{ color: 'color-mix(in srgb, var(--text-color) 60%, transparent)' }}>Create your organization to get started</p>
            ...
            <form onSubmit={handleCreateOrg} className="flex flex-col gap-4">
              <div>
                ...
                <input id="org-name" type="text" required value={orgName} onChange={(e) => setOrgName(e.target.value)}
                  className="w-full rounded-lg border px-4 py-2.5 text-sm outline-none transition-colors"
                  style={{ backgroundColor: 'var(--second-bg-color)', borderColor: 'color-mix(in srgb, var(--text-color) 15%, transparent)', color: 'var(--text-color)' }}
